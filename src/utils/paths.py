...
RAW_ADMITTANCE_DIR: Path = RAW_MEASUREMENT_DIR / "admittance"
RAW_PHASE_DIR: Path = RAW_MEASUREMENT_DIR / "phase"
RAW_FLUX_DEPENDENCE_DIR: Path = RAW_MEASUREMENT_DIR / "flux_dependence"
